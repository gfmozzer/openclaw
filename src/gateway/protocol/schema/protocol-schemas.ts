...
import {
  ...
  DriverRegistryEntrySchema,
  ProviderModelEntrySchema,
  ProviderModelGroupSchema,
  DriverModelsGroupSchema,
  DriverProviderModelsGroupSchema,
} from "./providers.js";
import {
...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  ProvidersRegistryEntry: ProvidersRegistryEntrySchema,
  ProvidersRegistryListParams: ProvidersRegistryListParamsSchema,
  ProvidersRegistryListResult: ProvidersRegistryListResultSchema,
  DriverRegistryEntry: DriverRegistryEntrySchema,
  DriversRegistryListParams: DriversRegistryListParamsSchema,
  DriversRegistryListResult: DriversRegistryListResultSchema,
  ProvidersCredentialMeta: ProvidersCredentialMetaSchema,
  DriversCredentialsListParams: DriversCredentialsListParamsSchema,
  DriversCredentialsListResult: DriversCredentialsListResultSchema,
  DriversCredentialsUpsertParams: DriversCredentialsUpsertParamsSchema,
  DriversCredentialsUpsertResult: DriversCredentialsUpsertResultSchema,
  DriversCredentialsDeleteParams: DriversCredentialsDeleteParamsSchema,
  DriversCredentialsDeleteResult: DriversCredentialsDeleteResultSchema,
  DriversCredentialsTestParams: DriversCredentialsTestParamsSchema,
  DriversCredentialsTestResult: DriversCredentialsTestResultSchema,
  ProvidersCredentialsListParams: ProvidersCredentialsListParamsSchema,
  ProvidersCredentialsListResult: ProvidersCredentialsListResultSchema,
  ProvidersCredentialsUpsertParams: ProvidersCredentialsUpsertParamsSchema,
  ProvidersCredentialsUpsertResult: ProvidersCredentialsUpsertResultSchema,
  ProvidersCredentialsDeleteParams: ProvidersCredentialsDeleteParamsSchema,
  ProvidersCredentialsDeleteResult: ProvidersCredentialsDeleteResultSchema,
  ProvidersCredentialsTestParams: ProvidersCredentialsTestParamsSchema,
  ProvidersCredentialsTestResult: ProvidersCredentialsTestResultSchema,
  ProviderModelEntry: ProviderModelEntrySchema,
  ProviderModelGroup: ProviderModelGroupSchema,
  ProvidersModelsListParams: ProvidersModelsListParamsSchema,
  ProvidersModelsListResult: ProvidersModelsListResultSchema,
  DriverProviderModelsGroup: DriverProviderModelsGroupSchema,
  DriverModelsGroup: DriverModelsGroupSchema,
  DriversModelsListParams: DriversModelsListParamsSchema,
  DriversModelsListResult: DriversModelsListResultSchema,
  DriversProvidersListParams: DriversProvidersListParamsSchema,
